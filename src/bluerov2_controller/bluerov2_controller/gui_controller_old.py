...
class GUIController(Node):
    def __init__(self):
        ...
        self.add_slider("Yaw KP", self.control_frame, 0.0, 100.0, 47.62, self.yaw_kp_pub, 0, 0)
        ...
        self.add_slider("Lateral KP", self.control_frame, 0.0, 50.0, 37.5, self.lateral_kp_pub, 2, 0)
        ...
        self.add_slider("Forward Offset", self.control_frame, -2.0, 2.0, 0.7, self.forward_offset_pub, 4, 0)
        self.add_slider("Yaw Offset", self.control_frame, -50.0, 50.0, -8.93, self.yaw_offset_pub, 4, 2)
        self.add_slider("Lateral Offset", self.control_frame, -7.0, 7.0, 0.92, self.lateral_offset_pub, 5, 0)
