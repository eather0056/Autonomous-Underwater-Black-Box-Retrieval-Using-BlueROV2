...
class Controller(Node):    
    ...
    def __init__(self):
        ...
        self.gripper_value          = self.get_parameter("pwm_gripper_min").value
        ...
        gripper = UInt16()
        gripper.data = self.pwm_gripper_min
            ...
            for event in pygame.event.get():            
                ...
                if event.type == JOYBUTTONDOWN:
                 ...
                 # Check if a joystick axis motion event occurs
                    ...
                    elif event.axis == 3:                       # Right Joystick motion
    ...
    def adjust_gripper(self, direction):
        ...
        if direction == "open":
            target_value = self.gripper_value - self.gain_pwm_gripper
            msg.data = max(target_value, self.pwm_gripper_min)
        elif direction == "close":
            target_value = self.gripper_value + self.gain_pwm_gripper
            msg.data = min(target_value, self.pwm_gripper_max)            
    ...
    def calculate_pwm(self, value):
        ...
        return int(self.pwm_neutral + value * self.pwm_gain) # adjust the gain (self.pwm_max - self.pwm_neutral)
